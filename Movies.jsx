...
const Movies = () => {
  ...
  const handleLike = (movie) => {
    ...
    console.log("LN27: ", currentBookmark);

    setBookmarks(currentBookmark);
  };

  console.log("LN50: ", bookmarks);
  return (
    <>
            ...
            <div key={movies.imdbID}>
              <div className="subParent">
                ...
                <div className="cardbottom">
                  <h5>
                    {bookmarks[movies.imdbID] ? "Boomarked" : "Not bookmarked"}
                  </h5>
                  <div className="svgarea">
                    ...
                    >
                      {_renderSVG(bookmarks[movies.imdbID])}
                    </button>
                  </div>
                </div>
